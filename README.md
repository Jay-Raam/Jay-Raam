...
<p align="center">
  <img src="[https://skillicons.dev/icons](https://skillicons.dev/icons)?i=babel,bootstrap,html,css,express,figma,git,github,gitlab,ai,js,mongodb,mysql,nextjs,nodejs,npm,ps,react,sass,tailwind,ts,vercel,vite,vscode,xd,androidstudio,aws,azure,docker,firebase,flutter,gradle,postman,py,redis," />
</p>
  <br>
